  ...
  return (
    <div className="wrapper">
      <div className="max-w-5xl mx-auto flex flex-col gap-4 items-center justify-center">
        ...
        <a href="mailto:Abhisinghria@gmail.com">
      ...
      <div className="mt-8 flex items-center flex-wrap   gap-8 justify-center">
        <SocialLink title="Github" link="https://github.com/AbhishekSinghria" />
        <SocialLink
          title="Linkedin"
          link="https://www.linkedin.com/in/abhishek-singhria/s"
        />
        <SocialLink
          title="Instagram"
          link="https://www.instagram.com/abhi.chaudhary.1/"
        />
      </div>
    </div>
  );
