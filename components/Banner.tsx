...
import ProfileImg from "../public/img/ab.jpeg";
  ...
  return (
    <div className="wrapper flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="w-3/4 flex flex-col items-center md:items-start    gap-2">
        <h1 className="text-5xl font-bold text-white">Abhishek Singhria</h1>
        ...
        Bringing Intelligence to the Web: Where Machine Learning Meets Web Development
        </p>
      </div>
    </div>
  );
